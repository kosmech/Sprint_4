...
class TestQuestions:
    ...
    @allure.title('Тест 1-го вопроса')
    def test_text_questions_1(self, driver):
        self.driver = driver
    ...
    @allure.title('Тест 2-го вопроса')
    def test_text_questions_2(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 3-го вопроса')
    def test_text_questions_3(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 4-го вопроса')
    def test_text_questions_4(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 5-го вопроса')
    def test_text_questions_5(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 6-го вопроса')
    def test_text_questions_6(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 7-го вопроса')
    def test_text_questions_7(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
    ...
    @allure.title('Тест 8-го вопроса')
    def test_text_questions_8(self, driver):
        self.driver = driver
        base_page = BasePage(self.driver)
        section_questions = Questions(self.driver)
        base_page.wait_load_main_page()
